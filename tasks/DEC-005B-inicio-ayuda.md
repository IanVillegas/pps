...
- `ErrorIllustration` (`src/assets/images/ErrorIllustration.tsx`): ilustracion de error de Figma, nodo 43121:531 (un solo SVG con ovalo completo, ventana y destellos; sin el icono de lupa de la version anterior). Reemplaza la version que combinaba dos capas (nodos 43121:478 y 43121:493) y traia el ovalo fragmentado con costura. Resuelve el "Ilustracion de error" que `src/assets/README.md` tenia anotado como pendiente desde DEC-001A.
