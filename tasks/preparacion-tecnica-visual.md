...
| Campo de texto            | `Atoms/InputText`                             | ForwardRef y atributos nativos; label sin htmlFor, errores sin asociacion ARIA y `maxlength` personalizado descartado. Usar `maxLength` nativo                                        |
| Contrasena                | `Atoms/InputSecret`                           | Visibilidad y errores; referencia interna de foco no conectada. Label sin htmlFor y handlers externos pueden sustituir onBlur/onFocus internos                                        |
...
| Modal                     | `Organisms/Modal`                             | Radix AlertDialog, contenido y acciones; width/height declarados no usados; ancho inline 535 o marginContent, clases con ternarios literales. No asumir adecuado para todo formulario |
...
| Checkbox / switch / radio | Dependencias Radix; CardRadioButton           | No hay equivalentes genericos exportados para todos los controles Figma                                                                                                               |
...
| Texto       | Poppins 12/14/16 px segun funcion                                                                     | Conservar tamanos legibles y contrastar cada rol                                         |
| Marca       | Rojo 2026 #E62C3A y logo nuevo                                                                        | Shared usa logo naranja y rojo #E5353E en escala heredada                                |
| CTA         | Amarillo #FDD058, radio 10 px; login 48 px alto, pasos con variantes 60 px                            | Variante propia requerida; no hacer reemplazo global de todos los botones                |
...
| Verde       | Conviven #12A195 y #47D1C6 heredados con #00998A y #45B9B2 de 2026                                    | Registrar rol por componente; resolver mezcla antes de fijar tokens finales              |
...
| Responsive  | No se identificaron variantes moviles DecPat en esta pagina; GM contiene ejemplos moviles             | Propuesta de QA: 360, 768, 1366 y 1440 px; detalles responsivos pendientes de validacion |
...
| D-02 | Prefijo local y prefijo de despliegue real                     | DEC-001; eliminar dependencia conceptual de /seguridad en rutas propuestas                                                                        |
